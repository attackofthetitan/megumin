...
public class ExplosionRayEntityRenderer extends EntityRenderer<ExplosionRayEntity, ExplosionRayEntityRenderState> {
    ...
    @Override
    public void render(ExplosionRayEntityRenderState state, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int light) {
        matrixStack.push();
    ...
    @Override
    public ExplosionRayEntityRenderState createRenderState() {
        return new ExplosionRayEntityRenderState();
    }
}
